...
const SODIUM_LIBRARY_VERSION = '0.0.0';
const SODIUM_LIBRARY_MAJOR_VERSION = 1;
const SODIUM_LIBRARY_MINOR_VERSION = 0;
...
if (!\extension_loaded('sodium')) {
    ...
    function sodium_crypto_aead_chacha20poly1305_encrypt(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_aead_chacha20poly1305_encrypt($msg, $nonce, $key, $ad);
        }
        return '';
    }
    ...
    function sodium_crypto_box_publickey_from_secretkey(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_box_publickey_from_secretkey($secretkey);
        }
        return '';
    }
    ...
    function sodium_crypto_box_seal_open(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_box_seal_open($encrypted, $keypair);
        }
        return '';
    }
    ...
    function sodium_crypto_kx(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_kx($secretkey, $publickey, $client_publickey, $server_publickey);
        }
        return '';
    }
    ...
    function sodium_crypto_generichash_init(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_generichash_init($key, $length);
        }
        return '';
    }
    ...
    function sodium_crypto_generichash_update(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_generichash_update($hashState, $append);
        }
    }
    ...
    function sodium_crypto_generichash_final(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_generichash_final($hashState, $length);
        }
        return '';
    }
    ...
    function sodium_crypto_pwhash(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_pwhash($out_len, $passwd, $salt, $opslimit, $memlimit);
        }
        return '';
    }
    ...
    function sodium_crypto_pwhash_scryptsalsa208sha256(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_pwhash_scryptsalsa208sha256($out_len, $passwd, $salt, $opslimit, $memlimit);
        }
        return '';
    }
    ...
    function sodium_crypto_pwhash_scryptsalsa208sha256_str(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_pwhash_scryptsalsa208sha256_str($passwd, $opslimit, $memlimit);
        }
        return '';
    }
    ...
    function sodium_crypto_pwhash_scryptsalsa208sha256_str_verify(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_pwhash_scryptsalsa208sha256_str_verify($hash, $passwd);
        }
        return false;
    }
    ...
    function sodium_crypto_scalarmult(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_scalarmult($ecdhA, $ecdhB);
        }
        return '';
    }
    ...
    function sodium_crypto_shorthash(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_shorthash($message, $key);
        }
        return '';
    }
    ...
    function sodium_crypto_sign(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_sign($message, $secretkey);
        }
        return '';
    }
    ...
    function sodium_crypto_sign_ed25519_pk_to_curve25519(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_sign_ed25519_pk_to_curve25519($sign_pk);
        }
        return '';
    }
    ...
    function sodium_crypto_sign_ed25519_sk_to_curve25519(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_sign_ed25519_sk_to_curve25519($sign_sk);
        }
        return '';
    }
    ...
    function sodium_crypto_sign_keypair_from_secretkey_and_publickey(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_keypair_from_secretkey_and_publickey($secretkey, $publickey);
        }
        return '';
    }
    ...
    function sodium_crypto_sign_open(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_sign_open($signed_message, $publickey);
        }
        return '';
    }
    ...
    function sodium_crypto_sign_publickey_from_secretkey(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_sign_publickey_from_secretkey($secretkey);
        }
        return '';
    }
    ...
    function sodium_crypto_sign_verify_detached(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_sign_verify_detached($signature, $msg, $publickey);
        }
        return false;
    }
    ...
    function sodium_crypto_stream(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_stream($length, $nonce, $key);
        }
        return '';
    }
    ...
    function sodium_crypto_stream_xor(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\crypto_stream_xor($plaintext, $nonce, $key);
        }
        return '';
    }
    ...
    function sodium_compare(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\compare($left, $right);
        }
        return 0;
    }
     ...
     * @return string
     */
    function sodium_increment(string &$nonce)
    {
        if (\extension_loaded('libsodium')) {
            return \Sodium\increment($nonce);
        }
        return '';
    }
    ...
    function sodium_crypto_scalarmult_base(
        ...
        if (\extension_loaded('libsodium')) {
            return \Sodium\scalarmult_base($sk);
        }
        return '';
    }
}